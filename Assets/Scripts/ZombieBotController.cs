...
public class ZombieBotController : MonoBehaviour
{
    ...
    internal NavMeshAgent navMeshAgent; // Navigation mesh agent for AI movement
    internal NavMeshPath navMeshPath; // Path generated by the NavMeshAgent
    ...
    internal Animator animator; // Animator component for animations
    internal int isWalkingHash; // Hash of the 'isWalking' animation parameter
    internal int isRunningHash; // Hash of the 'isRunning' animation parameter
    internal int isAttackingHash; // Hash of the 'isAttacking' animation parameter

    // Ragdoll components
    internal Rigidbody[] ragdollRigidbodies; // Array of ragdoll rigidbodies
    internal CharacterController characterController; // Character controller for movement
    ...
    internal float attackSoundCooldown = 2.0f; // Cooldown for attack sounds
    internal float lastAttackSoundTime = -1.0f; // Time when the last attack sound played
    internal AudioSource hurtAudioSource; // Audio source for hurt sounds

    // Controlled movement variables
    public Vector2 controlledMovementVector; // Movement vector when controlled
    internal bool isControlledRunning; // Flag indicating if the zombie is running when controlled
    ...
    internal bool IsPathMostlyStraight()
    {
    ...
    internal void RunningAiBehaviour()
    {
    ...
    internal void StartAiAttacking()
    {
    ...
    internal void AiAttackingBehaviour()
    {
    ...
    internal void ControllingBehaviour()
    {
    ...
    internal void RagdollBehaviour()
    {
